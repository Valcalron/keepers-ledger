const CACHE='keepers-companion-static-v8';
const FILES=['./','index.html','reset.html','styles.css','app.js','manifest.webmanifest','icon.svg','day-pride.svg','day-gluttony.svg','day-envy.svg','day-wrath.svg','day-sloth.svg','day-lust.svg'];
